...
export const LocationsCard = ({title, description, imgUrl, points, location, standing}) => {
return(
...
<Text style={{marginHorizontal: 4, color:"gray", fontSize: 12}}>{location}</Text>
      </View>
...
elevation: 4,
    ...
    standing: {
        fontSize: 45,fontWeight: "bold",position: 'absolute', top: 0, left: -30, right: 0, bottom: 0, color: "#00CCBB"
        },
    subHeadline: {
        fontSize: 14,
        padding: 4,
